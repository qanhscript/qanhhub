...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>qanhZz Hub chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "qanhZz Hub", HidePremium = false, IntroText = "qanhZz Hub⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("qanhZz Hub SCRIPT")
W:AddLabel("DiscordqanhZz Hub")
local Section = W:AddSection({
    Name = "Status"
})
